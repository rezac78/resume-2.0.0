...
export default function Reload(props: ReloadProps) {
        return (
                <>
                        {props.alert ? <div className="fixed top-2/4 items-center block w-full p-6 bg-white border border-gray-100 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-800 dark:hover:bg-gray-700">
