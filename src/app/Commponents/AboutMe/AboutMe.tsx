                                ...
                                <div className="flex w-full dark:border-2 dark:border-inherit shadow-xl tablet:shadow-2xl shadow-[#1f2235]">
                                        ...
                                        <div className="w-full tablet:w-6/12 text-justify p-4 tablet:p-9">
                                                ...
                                                <div className="mobile:flex justify-evenly mt-5">
                                                        <Bouttons LinkHref="#ContactMe" target="_blank" download="#" Title={t("ContactMe")} classButtons="w-full mobile:w-40 border-inherit dark:border-dark-color-text bg-black border-2 hover:border-ligth-color-text hover:dark:border-white" />
                                                        <Bouttons LinkHref="#ContactMe" target="_blank" download="#" Title={t("GetResume")} classButtons="w-full mobile:w-40 bg-ligth-color-text dark:bg-dark-color-text dark:text-black hover:bg-white hover:dark:bg-white hover:text-black" />
                                                </div>
                                        </div>
                                </div>
                        </div>
